% Your original 1x700 double array
originalArray = dFFv; % Replace this with your actual data

% Convert to a 700x1 double cell array
dFFv2 = {originalArray};

a = .19 % amplitude from villette paper
tau = 0.0012494 % decay from villette paper
ton = 0.00079444 % rise
sigma = 0.0415
drift = 0.20722
dt = 0.0002 % 5000 Hz
...
ntrial = 1;
T = 140.8990000037135;
rate = 0.001; % WHAT IS THIS? an estimate of how many spikes per second?
...
% spike estimation
[spikest fit drift] = spk_est(dFFv2,par);
...
[tauest aest sigmaest] = spk_autocalibration(dFFv2,pax)
